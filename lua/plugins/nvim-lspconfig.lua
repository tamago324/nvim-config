...
vim.api.nvim_create_autocmd('LspAttach', {
  callback = function (ev)
    ...
    vim.keymap.set("n", "td", function() vim.lsp.buf.definition({ loclist = false }) end, map_opts)
    vim.keymap.set("n", "tl", function() vim.lsp.buf.references({ includeDeclaration = false }, { loclist = false }) end, map_opts)
    vim.keymap.set("n", "tt", function() vim.lsp.buf.type_definition({ loclist = false }) end, map_opts)
    vim.keymap.set("n", "ti", function() vim.lsp.buf.implementation({ loclist = false }) end, map_opts)
