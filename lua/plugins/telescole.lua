...
local map_ext = function(mode, lhs, name, opts)
	local mapp = function(_mode, _lhs, _rhs, _opts)
		vim.api.nvim_set_keymap(
			...
			_lhs,
			_rhs,
			vim.tbl_extend("keep", _opts or {}, { silent = true, noremap = true })
		)
	end
...
vim.api.nvim_create_user_command("TouchLua", function()
	require("plugins.telescope.plugins")({ type = "lua" })
end, {})

vim.api.nvim_create_user_command("TouchVim", function()
	require("plugins.telescope.plugins")({ type = "vim" })
end, {})
